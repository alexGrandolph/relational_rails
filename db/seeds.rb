...
#salamon skis
spark = salamon.skis.create(model: "QST Spark", ski_type: "Park", longest_offered_cm: 189, symmetrical: true)
blank = salamon.skis.create(model: "QST Blank", ski_type: "All Mountain", longest_offered_cm: 202, symmetrical: false)
...
#icelantic skis
nomad = ski_maker1.skis.create(model: "Nomad", ski_type: "Park", longest_offered_cm: 191, symmetrical: true)
shaman = ski_maker1.skis.create(model: "Shaman", ski_type: "Powder", longest_offered_cm: 209, symmetrical: false)
madien = ski_maker1.skis.create(model: "Madien", ski_type: "Park", longest_offered_cm: 178, symmetrical: true)
saba = ski_maker1.skis.create(model: "Saba", ski_type: "All Mountain", longest_offered_cm: 201, symmetrical: false)
